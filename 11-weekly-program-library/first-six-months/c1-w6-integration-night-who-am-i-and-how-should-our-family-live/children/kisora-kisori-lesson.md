...
# Kiśora–Kiśorī Lesson — Integration Night: Who Am I, and How Should Our Family Live?
...
| 5–15 min | **Text observation** — BG 2.13 |
...
### Text observation — BG 2.13

KUTUMBA summary (not full purport):

> Integration anchor — sober person not bewildered by bodily change.

**Observe:** (1) Key terms (2) Promised result (3) One home action

Reference: [https://vedabase.io/en/library/bg/2/13/](https://vedabase.io/en/library/bg/2/13/)
