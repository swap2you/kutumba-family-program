...
- [research/CLAIM-REGISTER.yaml](../research/CLAIM-REGISTER.yaml) — 10 claims
...
- [research/SOURCE-MATRIX.md](../research/SOURCE-MATRIX.md) — 9 sources
...
| DR-04 | Key verse [Bhagavad-gītā 14.5](https://vedabase.io/en/library/bg/14/5/) anchors module | Pass-pending | Edition check |
| DR-05 | No human approval claimed in review-status | Pass | — |

## Sample claims for spot-check

Spot-check claim IDs: CLM-001, CLM-002, CLM-003, CLM-004, CLM-005, and remaining entries in register.
...
3. Approve katha paraphrase for The brāhmaṇa who saw the modes in daily life
