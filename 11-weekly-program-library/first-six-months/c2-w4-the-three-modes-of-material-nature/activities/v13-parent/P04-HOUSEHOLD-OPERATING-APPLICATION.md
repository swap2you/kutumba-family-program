# C2-W4 · P04-HOUSEHOLD-OPERATING-APPLICATION · Household operating application

**Print:** US Letter · Parent  
**Primary mechanic:** Scenario sorting  
**Primary bridge:** BG 14.5  
...
One five-minute reset ritual for seven days.

Memory line: **Calm helps me hear Kṛṣṇa.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C2-W4.py`.
2. State the purpose in one sentence; name the care boundary: Never label persons. Avoid food policing. Environment supports practice; devotion is the goal.
