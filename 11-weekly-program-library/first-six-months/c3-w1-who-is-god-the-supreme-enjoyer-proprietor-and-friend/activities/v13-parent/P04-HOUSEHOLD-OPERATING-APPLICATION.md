# C3-W1 · P04-HOUSEHOLD-OPERATING-APPLICATION · Household operating application

**Print:** US Letter · Parent  
**Primary mechanic:** Triple-lens map  
**Primary bridge:** BG 5.29  
...
One stewardship sentence + one friend act.

Memory line: **Kṛṣṇa owns, enjoys, befriends.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C3-W1.py`.
2. State the purpose in one sentence; name the care boundary: Age-appropriate ownership/friendship/service; no speculative iconography.
