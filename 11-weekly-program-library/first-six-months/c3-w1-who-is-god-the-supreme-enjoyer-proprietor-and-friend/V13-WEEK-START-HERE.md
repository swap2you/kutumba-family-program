# V13 WEEK START HERE — C3-W1

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C3-W1 — Who Is God? The Supreme Enjoyer, Proprietor and Friend  
**Date:** Saturday 09 Jan 2027  
**This is the only C3-W1 operational entry point for V13.**
...
| Misconception to block | God as remote force only; ownership means domination without friendship/service. |
| Care boundary | Age-appropriate ownership/friendship/service; no speculative iconography. |
...
1. Open this file.
2. When available, print `exports/final/v13/C3/C3-W1/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Minimum before next Saturday: **memory line once + one act of care for something we steward for Kṛṣṇa.**  
...
**C3-W2 — Who Is Kṛṣṇa? The Supreme Personality of Godhead.** Do not teach the next week’s full ontology tonight.
...
**Verdict language allowed:** C3-W1 owner-runnable pack authored — human/temple external gates remain open.  
