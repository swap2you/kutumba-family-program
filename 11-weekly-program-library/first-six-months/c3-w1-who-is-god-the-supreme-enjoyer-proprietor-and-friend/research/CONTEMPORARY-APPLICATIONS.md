# C3-W1 Contemporary Applications

| Case ID | Scenario | Principle applied | Facilitator note |
| --- | --- | --- | --- |
| CS-01 | Family schedule conflict over control | Peace comes from knowing Kṛṣṇa as the supreme enjoyer, propr… | Anonymized; no forced disclosure |
