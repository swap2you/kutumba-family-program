...
- [research/CONTEMPORARY-APPLICATIONS.md](../research/CONTEMPORARY-APPLICATIONS.md) — 6 cases
...
| PR-04 | Bhakti lab linked: Bedtime Remembrance Routine | Pass-pending | — |
| PR-05 | Integration/safeguarding notes match module risks file | Pass-pending | Bereavement opt-out for C2-W3 |

## Age-track notes

- **Lāla–Lālī:** NO frightening death imagery. Feelings cards: sad, confused, peaceful, worried — all OK to share with trusted adult. Redirect graphic questions to parents.
