# C1-W4 Main Facilitator Guide — Saturday 2:00–4:00

## Two-minute summary

Human life gives a rare opportunity for deliberate self-realization — protect inquiry and practice time. Primary scripture: **SB 11.9.29** (https://vedabase.io/en/library/sb/11/9/29/).
...
1. Open https://vedabase.io/en/library/sb/11/9/29/ and reread paraphrase: After many births one attains the rare human form — use it for self-realization.
2. Rehearse opening script aloud once.
3. Pack materials for younger + older tracks.
4. Review misconception: Use fear or death-pressure to motivate children.
...
> Welcome. Today is C1-W4: Why Human Life Is Rare and Valuable.  
> Our essential question is: What deserves protected family time?  
> From SB 11.9.29, we remember: After many births one attains the rare human form — use it for self-realization.  
...
Key paraphrase of SB 11.9.29: After many births one attains the rare human form — use it for self-realization.

Common error to block: **Use fear or death-pressure to motivate children.**

## Analogies / examples with limits

- **Rare ticket:** Opportunity must be used (limit: Not scare tactic)
- **Crossroads sign:** Choice of path matters (limit: No species contempt)
- **Seed season:** Plant while season open (limit: No guaranteed harvest timing)
...
1. Screens consume protected practice slot → avoid: Entertainment first is fine
2. Parent uses death scare on child → avoid: Fear creates urgency
3. Family fills calendar; no inquiry time → avoid: Busy = successful
...
| Question | Direction |
|---|---|
| Do we have to be perfect? | No — minimum versions are allowed; regularity matters (SB 11.9.29). |
...
Invite one sentence per family: "This week we will…" tied to What deserves protected family time?.
