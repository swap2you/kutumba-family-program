...
# Kiśora–Kiśorī Lesson — Why Human Life Is Rare and Valuable

**Total time:** 40 minutes  
**Essential question:** Why is human intelligence a special opportunity — and how do we use time without panic?  
...
| 5–15 min | **Text observation** — SB 11.9.29 |
...
### Text observation — SB 11.9.29

KUTUMBA summary (not full purport):

> Having obtained rare human life, one should not waste it.

**Observe:** (1) Key terms (2) Promised result (3) One home action

Reference: [https://vedabase.io/en/library/sb/11/9/29/](https://vedabase.io/en/library/sb/11/9/29/)
