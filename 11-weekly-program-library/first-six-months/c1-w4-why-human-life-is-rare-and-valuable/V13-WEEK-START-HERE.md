# V13 WEEK START HERE — C1-W4

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C1-W4 — Why Human Life Is Rare and Valuable  
**Date:** Saturday 3 Oct 2026  
**This is the only C1-W4 operational entry point for V13.**
...
| Primary mechanic | Time-budget challenge (jar / priority / schedule audit) |
| Special safeguard | If Mṛgāri is used: CC Madhya 24.229–282 — NOT ŚB. |
...
1. Open this file.
2. When available, print `exports/final/v13/C1/C1-W4/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Ideal: memory line + one-sentence paraphrase of ŚB 11.9.29 + one gratitude/service act (5–15 min).  
...
**C1-W5 — The Temporary World and the Search for Permanent Happiness. Do not teach full temporary-world ontology tonight.**
...
**Verdict language allowed:** C1-W4 owner-runnable pack authored — human/temple external gates remain open.  
