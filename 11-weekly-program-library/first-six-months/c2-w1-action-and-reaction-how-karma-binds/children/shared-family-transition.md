...
audience: All ages — reunification
component: children/shared-family-transition.md
---
...
| 5–8 min | **Family pair practice:** Complete one step from Before–During–After Service Method or show child's recall card |
...
> **Leader:** Choices are seeds. I want to plant service seeds.  
> **All:** Choices are seeds. I want to plant service seeds.

## Bridge to Bhakti laboratory

"We practice together now — Before–During–After Service Method." See [bhakti-lab.md](../bhakti-lab.md)
