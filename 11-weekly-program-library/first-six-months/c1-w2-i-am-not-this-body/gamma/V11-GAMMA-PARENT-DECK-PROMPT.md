# C1-W2 V11 Gamma Parent Deck Prompt
...
- **Audience:** parent
- **Purpose:** Adult application for C1-W2
- **On-slide content:**
  - How should knowing I am not only this body change how we speak about bodies?
  - Write silently for 30 seconds
- **Presenter notes:** Invite honesty without confession pressure Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
- **Suggested visual:** Parent circle quiet writing
- **Image/diagram prompt:** Warm living-room scene for: How should knowing I am not only this body change how we speak about bodies?
...
- **Presenter notes:** Keep phone/browser ready with verse page Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
- **Suggested visual:** Verse card with VedaBase URL
- **Image/diagram prompt:** Clean verse-reference card for BG 2.13
- **Interaction:** Ask one parent to restate the household implication
- **Do-not-claim:** Not human-approved; not publication-ready; Gamma not rendered; science ≠ siddhānta
- **Accessibility note:** Large type; high contrast; read key lines aloud.
...
- **Presenter notes:** Connect to Sunday dinner / bedtime cue Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **Presenter notes:** Do not use real family names Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **On-slide content:**
  ...
  - What not to say
  - Minimum version
- **Presenter notes:** Block shame language Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **Presenter notes:** Model repair language Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **Presenter notes:** Write saṅkalpa on card Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **On-slide content:**
  ...
  - Backup cue
- **Presenter notes:** Include grandparents/caregivers if relevant Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **On-slide content:**
  ...
  - No perfectionism
- **Presenter notes:** Keep compassionate Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **Purpose:** Adult application for C1-W2
- **On-slide content:**
  - Project layer for C1-W2
  - ≤20 minutes optional burden
  - Keep artifact for W6
- **Presenter notes:** Point to project/CYCLE-CONTRIBUTION.md Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
- **Suggested visual:** Project folder icon + week label
- **Image/diagram prompt:** Simple project folder labeled C1-W2
- **Interaction:** Ask one parent to restate the household implication
- **Do-not-claim:** Not human-approved; not publication-ready; Gamma not rendered; science ≠ siddhānta
- **Accessibility note:** Large type; high contrast; read key lines aloud.
...
- **On-slide content:**
  ...
  - No sādhana scoring
  - No gossip
- **Presenter notes:** Remind covenant Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
...
- **Presenter notes:** Collect one spoken sentence per family Block misconception: Psychology or photos prove the soul.
- **Primary source:** BG 2.13 — https://vedabase.io/en/library/bg/2/13/
