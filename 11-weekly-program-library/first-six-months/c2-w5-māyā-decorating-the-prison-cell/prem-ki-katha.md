...
# Prem-kī-Kathā — The fish in the well

## 1. Katha title

**The fish in the well** — SB 7.5 — limited vision within māyā's covering

## 2. Module connection

Māyā is Kṛṣṇa's material energy; surrender and practice cross it — people are not māyā.

**Scope boundary:** Misogynistic 'women are māyā'; world-hatred; diagnosing addiction publicly

## 3. Primary source references

| Source | Link | Use in katha |
|---|---|---|
| SB 7.5.23 | [vedabase](https://vedabase.io/en/library/sb/7/5/23/) | Katha anchor |
| BG 7.14 | [vedabase](https://vedabase.io/en/library/bg/7/14/) | Katha anchor |
| BG 2.62 | [vedabase](https://vedabase.io/en/library/bg/2/62/) | Katha anchor |
...
**Paraphrase (source-grounded):** Prahlāda Mahārāja taught that persons absorbed only in family, shop, and neighborhood comfort may mistake a small well for the whole ocean — like a fish who has never seen the sea.

**Paraphrase (source-grounded):** The covering of māyā is not that matter is unreal in every sense; it is that misplaced attachment makes us forget Kṛṣṇa and our actual interest.

**Paraphrase (source-grounded):** Crossing māyā comes through surrender to Kṛṣṇa and devotional shelter — not hatred of the world, not demeaning women, and not mere white-knuckle control without replacement practice.
...
**Paraphrase — setting the heart:** Before precise philosophy, the heart needs a real scene: persons, struggle, and turning toward the Lord. This katha supplies that scene for **C2-W5** without inventing dialogue.

**Paraphrase — Bhagavad-gītā 7.14 (application summary):** The verse is not a slogan. It names a distinction families can practice this week: see BG 7.14, 2.62–63, 15.7, 9.10; prison-cell analogy; attention boundaries in one honest situation at home.

**Paraphrase — memory line practice:** Repeat together: _Kṛṣṇa's material energy is difficult to overcome, but those who surrender to Him can cross beyond it._ — then name one place this week the line might actually help (mealtime, bedtime, conflict, service).
...
**Paraphrase — home practice seed:** Before leaving, each family names one trigger (time, place, or event) for the minimum practice connected to C2-W5.
...
**Memory line:** Kṛṣṇa's material energy is difficult to overcome, but those who surrender to Him can cross beyond it.
...
1. **Chariot/picture cue:** Shiny puppet toy flashes and beeps during cleanup time. Children practice: put down, three breaths, one chant, pick up one toy for Kṛṣṇa. Sticky-note path shows how each 'just one look' adds up.
2. **Recall game:** People are not māyā. I can stop, chant once, and choose help.
3. **Safeguarding:** Say clearly: People are not māyā. No inappropriate media displayed in class.
...
Parents carry the week's principle into home practice. Link to [`family-home-practice.md`](family-home-practice.md) and Attention Boundary and Japa Shelter. When children ask hard questions, turn toward śāstra together — permission to not have every answer immediately.
