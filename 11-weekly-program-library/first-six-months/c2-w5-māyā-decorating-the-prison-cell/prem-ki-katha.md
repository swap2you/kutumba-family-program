...
This katha supports **Māyā: Decorating the Prison Cell** and the key verse [7.14](https://vedabase.io/en/library/bg/7/14/).

**Memory line:** Kṛṣṇa's material energy is difficult to overcome, but those who surrender to Him can cross beyond it.

**Scope boundary:** BG 7.14, 2.62–63, 15.7, 9.10; prison-cell analogy; attention boundaries. Exclusions: Misogynistic 'women are māyā'; world-hatred; diagnosing addiction publicly

## 3. Primary source references

| Source | Link | Use in katha |
|---|---|---|
| SB 7.5.23 | [https://vedabase.io/en/library/sb/7/5/23/](https://vedabase.io/en/library/sb/7/5/23/) | Katha anchor |
| BG 7.14 | [https://vedabase.io/en/library/bg/7/14/](https://vedabase.io/en/library/bg/7/14/) | Katha anchor |
| BG 2.62 | [https://vedabase.io/en/library/bg/2/62/](https://vedabase.io/en/library/bg/2/62/) | Katha anchor |
...
Link to [`family-home-practice.md`](family-home-practice.md) and Attention Boundary and Japa Shelter in [`bhakti-lab.md`](bhakti-lab.md).
...
| 3 | Key verse card | https://vedabase.io/en/library/bg/7/14/ |
