# C2-W5 V12 Gamma older-4-5 Deck
...
- **Exact on-screen copy:**
  ...
  - Māyā is hard to cross; surrender to Kṛṣṇa is the way.
...
- **Detailed AI image prompt:** Instructional older-child learning scene for C2-W5, notebooks, calm focus, 16:9
- **Diagram instructions:** none unless puzzle
- **Source:** BG 7.14 — https://vedabase.io/en/library/bg/7/14/
- **Presenter notes:** text observation/puzzle/scenario. Block: Hate all material duty.
...
- **Exact on-screen copy:**
  ...
  - Meaning: This divine illusory energy made of the modes is hard to overcome — but those who surrende
- **Screen composition:** Title top; content mid; footer source
- **Palette role:** teal/saffron by audience
- **Typography:** 15–40 words
- **Visual type:** age-appropriate visual
