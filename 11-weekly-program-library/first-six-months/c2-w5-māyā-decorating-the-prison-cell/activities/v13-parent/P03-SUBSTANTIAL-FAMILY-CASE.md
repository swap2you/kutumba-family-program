# C2-W5 · P03-SUBSTANTIAL-FAMILY-CASE · Substantial family case

**Print:** US Letter · Parent  
**Primary mechanic:** Attention trap cases  
**Primary bridge:** BG 7.14  
...
Family upgrades gadgets weekly while skipping shared chanting.

Memory line: **Surrender crosses māyā.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C2-W5.py`.
2. State the purpose in one sentence; name the care boundary: Age-sensitive; no fear/paranoia; decorating-prison analogy with limits.
