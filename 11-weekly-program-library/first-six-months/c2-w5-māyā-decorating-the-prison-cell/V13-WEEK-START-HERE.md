# V13 WEEK START HERE — C2-W5

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C2-W5 — Māyā: Decorating the Prison Cell  
**Date:** Saturday 05 Dec 2026  
**This is the only C2-W5 operational entry point for V13.**
...
1. Open this file.
2. When available, print `exports/final/v13/C2/C2-W5/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Minimum before next Saturday: **memory line once + one attention-audit minute before screens/chanting.**  
...
**C2-W6 — Integration Night: Choice, Consequence and the Modes.** Do not teach the next week’s full ontology tonight.
...
**Verdict language allowed:** C2-W5 owner-runnable pack authored — human/temple external gates remain open.  
