# C1-W3 Presentation Rubric (Non-Competitive)

Use for formative encouragement. **No ranking. No public failure labels.**

| Dimension | Emerging | Developing | Secure |
|---|---|---|---|
| Understanding | Names topic vaguely | States week's conclusion in own words | Connects conclusion to Bhagavad-gītā 2.20 paraphrase |
