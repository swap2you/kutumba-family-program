# C1-W3 Main Facilitator Guide — Saturday 2:00–4:00

## Two-minute summary

The jīva is eternal, conscious, individual, minute, and related to Kṛṣṇa in service — not God Himself. Primary scripture: **BG 2.20** (https://vedabase.io/en/library/bg/2/20/).
...
1. Open https://vedabase.io/en/library/bg/2/20/ and reread paraphrase: The soul is never born and never dies; eternal and unchanging.
2. Rehearse opening script aloud once.
3. Pack materials for younger + older tracks.
4. Review misconception: All souls are God / we are the Supreme.
...
- Supports: BG 15.7, BG 2.17, SB 5.10 summary context
...
> Welcome. Today is C1-W3: The Nature of the Soul.  
> Our essential question is: If I am a soul, how should I live?  
> From BG 2.20, we remember: The soul is never born and never dies; eternal and unchanging.  
...
Key paraphrase of BG 2.20: The soul is never born and never dies; eternal and unchanging.

Common error to block: **All souls are God / we are the Supreme.**

## Analogies / examples with limits

- **Sun and sunray:** Qualitative likeness; quantitative difference (limit: Ray is not the sun)
- **Spark from fire:** Same nature, dependent (limit: Not independent Godhood)
- **House and resident:** Resident ≠ house (limit: Can feel impersonal)
...
1. Child says 'I am God' → avoid: Soul = Supreme
2. Adult dismisses soul talk as anti-science → avoid: Science disproved the soul
3. Family neglects body care 'because we are soul' → avoid: Body contempt is spiritual
...
| Question | Direction |
|---|---|
| Do we have to be perfect? | No — minimum versions are allowed; regularity matters (BG 2.20). |
...
Invite one sentence per family: "This week we will…" tied to If I am a soul, how should I live?.
