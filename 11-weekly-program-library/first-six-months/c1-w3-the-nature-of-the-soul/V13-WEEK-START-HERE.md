# V13 WEEK START HERE — C1-W3

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C1-W3 — The Nature of the Soul  
**Date:** Saturday 26 Sep 2026  
**This is the only C1-W3 operational entry point for V13.**
...
| Primary mechanic | Classification map (soul is / is-not) |
...
1. Open this file.
2. When available, print `exports/final/v13/C1/C1-W3/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Ideal: memory line + one-sentence paraphrase of BG 2.20 + one gratitude/service act (5–15 min).  
...
**C1-W4 — Why Human Life Is Rare and Valuable. Do not teach full human-form rarity ontology tonight.**
...
**Verdict language allowed:** C1-W3 owner-runnable pack authored — human/temple external gates remain open.  
