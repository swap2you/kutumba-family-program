...
# Lāla–Lālī Lesson — What Is KUTUMBA, and Why Are We Here?

**Total time:** 40 minutes  
**Memory line:** "We help each other remember Kṛṣṇa."  
**Sanskrit phrase:** nityaṁ bhāgavata-sevayā  
...
| 5–15 min | **Story** — Sages at Naimiṣāraṇya (8 min + wonder questions) |
...
> Connect to memory line: "We help each other remember Kṛṣṇa."

**Wonder questions:** What changed? What stayed the same? How can our family practice this?

### Movement game

Four corners or relay aligned with `Family garden and protected weekly rhythm`. Two adults in visible space.
...
| 28–35 min | Sanskrit phrase echo: nityaṁ bhāgavata-sevayā |
