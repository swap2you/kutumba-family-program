# C1-W1 Presentation Rubric (Non-Competitive)

Use for formative encouragement. **No ranking. No public failure labels.**

| Dimension | Emerging | Developing | Secure |
|---|---|---|---|
| Understanding | Names topic vaguely | States week's conclusion in own words | Connects conclusion to Śrīmad-Bhāgavatam 1.2.18 paraphrase |
