...
- [research/CONTEMPORARY-APPLICATIONS.md](../research/CONTEMPORARY-APPLICATIONS.md) — 8 cases
...
| PR-04 | Bhakti lab linked: Five-Lens Family Case Lab | Pass-pending | — |
| PR-05 | Integration/safeguarding notes match module risks file | Pass-pending | Bereavement opt-out for C2-W3 |

## Age-track notes

- **Lāla–Lālī:** Fictional puppets only. No quizzes on deceased relatives or karma diagnosis.
