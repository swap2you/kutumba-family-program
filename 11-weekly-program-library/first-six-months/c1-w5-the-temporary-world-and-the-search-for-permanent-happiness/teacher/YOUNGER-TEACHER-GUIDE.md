# C1-W5 Younger Teacher Guide (K–2)

## Objective

Children can say and show: **Temporary joys can be used with gratitude; lasting fulfillment is in Kṛṣṇa.**
...
Primary: BG 8.15 — Having attained Me, great souls do not take rebirth into this temporary world of misery.  
Do not teach adult debates. Block: Material things and family affection are worthless.
...
Rules: no invented deity dialogue; no frightening detail; stop at the moral: Temporary things can be used well but cannot provide permanent fulfillment.

Sample framing:
> "Today we learn that Temporary things can be used well but cannot provide permanent fulfillment. The holy books help families remember this."
...
**Name:** "Freeze and Remember — C1-W5"  
...
Create a take-home card with the memory phrase on the inside and a simple drawing on the front related to The Temporary World and the Search for Permanent Happiness.

## Actual coloring / line-art task

Color `visuals/V11/line-art-younger.svg` (week-specific). Title the page with C1-W5.
