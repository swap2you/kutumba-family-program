# C1-W5 V11 Gamma Parent Deck Prompt
...
- **Audience:** parent
- **Purpose:** Adult application for C1-W5
- **On-slide content:**
  - How can enjoyment become gratitude and service?
  - Write silently for 30 seconds
- **Presenter notes:** Invite honesty without confession pressure Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
- **Suggested visual:** Parent circle quiet writing
- **Image/diagram prompt:** Warm living-room scene for: How can enjoyment become gratitude and service?
...
- **Presenter notes:** Keep phone/browser ready with verse page Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
- **Suggested visual:** Verse card with VedaBase URL
- **Image/diagram prompt:** Clean verse-reference card for BG 8.15
- **Interaction:** Ask one parent to restate the household implication
- **Do-not-claim:** Not human-approved; not publication-ready; Gamma not rendered; science ≠ siddhānta
- **Accessibility note:** Large type; high contrast; read key lines aloud.
...
- **Presenter notes:** Connect to Sunday dinner / bedtime cue Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **Presenter notes:** Do not use real family names Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **On-slide content:**
  ...
  - What not to say
  - Minimum version
- **Presenter notes:** Block shame language Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **Presenter notes:** Model repair language Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **Presenter notes:** Write saṅkalpa on card Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **On-slide content:**
  ...
  - Backup cue
- **Presenter notes:** Include grandparents/caregivers if relevant Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **On-slide content:**
  ...
  - No perfectionism
- **Presenter notes:** Keep compassionate Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **Purpose:** Adult application for C1-W5
- **On-slide content:**
  - Project layer for C1-W5
  - ≤20 minutes optional burden
  - Keep artifact for W6
- **Presenter notes:** Point to project/CYCLE-CONTRIBUTION.md Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
- **Suggested visual:** Project folder icon + week label
- **Image/diagram prompt:** Simple project folder labeled C1-W5
- **Interaction:** Ask one parent to restate the household implication
- **Do-not-claim:** Not human-approved; not publication-ready; Gamma not rendered; science ≠ siddhānta
- **Accessibility note:** Large type; high contrast; read key lines aloud.
...
- **On-slide content:**
  ...
  - No sādhana scoring
  - No gossip
- **Presenter notes:** Remind covenant Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
...
- **Presenter notes:** Collect one spoken sentence per family Block misconception: Material things and family affection are worthless.
- **Primary source:** BG 8.15 — https://vedabase.io/en/library/bg/8/15/
