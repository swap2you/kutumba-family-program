...
|---|---|---|---|
| BG 8.15 | https://vedabase.io/en/library/bg/8/15/ | Having attained the Lord, great souls do not return again to this temporary world of misery; they have reached the highest perfection. | Exact BBT English translation not copied; KUTUMBA teaching meaning is original paraphrase |

## Supporting primary references

| Reference | URL | Teaching use | Limitation |
|---|---|---|---|
| BG 5.22 | https://vedabase.io/en/library/bg/5/22/ | Pleasures born of sense contact are temporary — supporting application, not the locked primary. | Prefer paraphrase; no purport dump |
