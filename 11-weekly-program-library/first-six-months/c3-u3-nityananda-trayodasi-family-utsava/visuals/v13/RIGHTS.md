...
| File | Origin | Use |
|---|---|---|
| `mercy-chain.png` | KUTUMBA-original Pillow line art | internal teaching |
| `service-challenge-cards.png` | KUTUMBA-original Pillow line art | internal teaching |
| `sankirtana-invitation.png` | KUTUMBA-original Pillow line art | internal teaching |
