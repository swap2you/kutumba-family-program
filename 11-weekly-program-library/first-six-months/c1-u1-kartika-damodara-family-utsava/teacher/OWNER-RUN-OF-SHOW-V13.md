...
| # | Station |
|---|---|
| 1 | Story sequencing (all ages share launch) |
| 2 | Younger butter-pot / rope-of-love craft (LED lamp card) |
| 3 | Older Dāmodara narrative map from SB 10.9 |
| 4 | Parent gratitude/service + household remembrance plan |
| 5 | Family kīrtana (invitation, not volume contest) |
