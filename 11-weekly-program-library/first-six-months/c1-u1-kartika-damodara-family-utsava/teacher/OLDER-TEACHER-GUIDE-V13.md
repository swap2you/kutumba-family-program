# C1-U1 OLDER-TEACHER-GUIDE-V13

Use with printable stations. Operator completeness pack.

# Main Facilitator Guide — C1-U1

**Kārtika / Dāmodara Family Utsava** · Saturday 2026-10-31 (planning Saturday)  
...
Primary: **ŚB 10.9.18** (https://vedabase.io/en/library/sb/10/9/18/).  
Supporting chapter frame: ŚB 10.9 (https://vedabase.io/en/library/sb/10/9/).

## Exact primary

- **Reference:** ŚB 10.9.18
...
Story frame from ŚB 10.9 (paraphrase only; no invented dialogue): Mother Yaśodā’s household work and butter-churning lead to Kṛṣṇa’s butter mischief. She tries to bind Him. Rope after rope is short. When she is exhausted, Kṛṣṇa accepts her love and allows Himself
