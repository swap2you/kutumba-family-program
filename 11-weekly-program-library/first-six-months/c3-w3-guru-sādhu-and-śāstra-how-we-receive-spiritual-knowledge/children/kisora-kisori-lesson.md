...
# Kiśora–Kiśorī Lesson — Guru, Sādhu and Śāstra

**Total time:** 40 minutes  
**Essential question:** How do we receive spiritual knowledge safely?  
...
| 5–15 min | **Text observation** — BG 4.34 |
...
### Text observation — BG 4.34

KUTUMBA summary (not full purport):

> Learn truth by humble approach, inquiry and service to the realized teacher.

**Observe:** (1) Key terms (2) Promised result (3) One home action

Reference: [https://vedabase.io/en/library/bg/4/34/](https://vedabase.io/en/library/bg/4/34/)
