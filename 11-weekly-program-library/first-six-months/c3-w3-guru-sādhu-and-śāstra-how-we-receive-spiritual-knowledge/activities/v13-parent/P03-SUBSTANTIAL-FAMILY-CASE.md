# C3-W3 · P03-SUBSTANTIAL-FAMILY-CASE · Substantial family case

**Print:** US Letter · Parent  
**Primary mechanic:** Three-source verify  
**Primary bridge:** BG 4.34  
...
Relative forwards a dramatic spiritual rumor as “must share.”

Memory line: **Ask, serve, verify.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C3-W3.py`.
2. State the purpose in one sentence; name the care boundary: Age-appropriate authority boundaries; no personality cult; “I don’t know; I will verify.”
