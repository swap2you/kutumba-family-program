# C3-W3 Contemporary Applications

| Case ID | Scenario | Principle applied | Facilitator note |
| --- | --- | --- | --- |
| CS-01 | Family schedule conflict over control | Approach spiritual truth with humility, sincere inquiry and … | Anonymized; no forced disclosure |
