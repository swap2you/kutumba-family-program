# V13 WEEK START HERE — C3-W2

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C3-W2 — Who Is Kṛṣṇa? The Supreme Personality of Godhead  
**Date:** Saturday 16 Jan 2027  
**This is the only C3-W2 operational entry point for V13.**
...
1. Open this file.
2. When available, print `exports/final/v13/C3/C3-W2/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Minimum before next Saturday: **memory line once + one reverent sentence about Kṛṣṇa from a source.**  
...
**C3-W3 — Guru, Sādhu and Śāstra.** Do not teach the next week’s full ontology tonight.
...
**Verdict language allowed:** C3-W2 owner-runnable pack authored — human/temple external gates remain open.  
