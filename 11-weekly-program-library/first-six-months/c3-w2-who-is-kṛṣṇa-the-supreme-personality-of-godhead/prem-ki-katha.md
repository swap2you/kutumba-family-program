...
Leads naturally to Bhagavad-gītā 7.7. See [`katha/KATHA-SOURCE-REGISTER.yaml`](katha/KATHA-SOURCE-REGISTER.yaml).

## 3. Primary source references

| Source | Link | Use in katha |
|---|---|---|
| SB 10.3.1 | [vedabase](https://vedabase.io/en/library/sb/10/3/1/) | Katha anchor |
| SB 10.3.43 | [vedabase](https://vedabase.io/en/library/sb/10/3/43/) | Katha anchor |
| BG 7.7 | [vedabase](https://vedabase.io/en/library/bg/7/7/) | Katha anchor |
| SB 1.3.28 | [vedabase](https://vedabase.io/en/library/sb/1/3/28/) | Katha anchor |
...
1. **Journal prompt:** "One sentence — how does this katha connect to Bhagavad-gītā 7.7?"
