# C3-W2 · P04-HOUSEHOLD-OPERATING-APPLICATION · Household operating application

**Print:** US Letter · Parent  
**Primary mechanic:** Source identity  
**Primary bridge:** BG 7.7  
...
One reverence speech rule for seven days.

Memory line: **Nothing is above Kṛṣṇa.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C3-W2.py`.
2. State the purpose in one sentence; name the care boundary: Authorized sources only; no speculative theology; reverence over aggression.
