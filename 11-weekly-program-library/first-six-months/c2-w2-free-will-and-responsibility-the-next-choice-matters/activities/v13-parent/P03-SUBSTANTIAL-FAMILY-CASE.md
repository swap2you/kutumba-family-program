# C2-W2 · P03-SUBSTANTIAL-FAMILY-CASE · Substantial family case

**Print:** US Letter · Parent  
**Primary mechanic:** Decision tree  
**Primary bridge:** BG 18.63  
...
Teen freezes after a grade drop; parent says “you had no choice but to fail.”

Memory line: **The next choice matters.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C2-W2.py`.
2. State the purpose in one sentence; name the care boundary: Do not blame children for events beyond their control; distinguish agency from total control.
