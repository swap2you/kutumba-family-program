# V13 WEEK START HERE — C2-W2

**KUTUMBA · Families Growing in Krishna Consciousness**  
**Program Director: Swapnil Patil**  
**Week:** C2-W2 — Free Will and Responsibility: The Next Choice Matters  
**Date:** Saturday 14 Nov 2026  
**This is the only C2-W2 operational entry point for V13.**
...
1. Open this file.
2. When available, print `exports/final/v13/C2/C2-W2/` Saturday packet (builders ready; DOCX/PDF render may follow).
...
Minimum before next Saturday: **memory line once + name one next responsible choice for tomorrow morning.**  
...
**C2-W3 — Birth, Death and Reincarnation.** Do not teach the next week’s full ontology tonight.
...
**Verdict language allowed:** C2-W2 owner-runnable pack authored — human/temple external gates remain open.  
