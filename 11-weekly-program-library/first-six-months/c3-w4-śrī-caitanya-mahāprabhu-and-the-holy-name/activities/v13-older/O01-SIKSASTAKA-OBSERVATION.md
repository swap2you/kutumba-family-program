# C3-W4 · O01-SIKSASTAKA-OBSERVATION · Śikṣāṣṭaka / CC Antya 20.12 observation

**Print:** US Letter · Grades 4–5  
**Primary mechanic:** Kīrtana etiquette  
**Primary bridge:** CC Antya 20.12  
...
Full source-language layer + teaching meaning.

Memory line: **Paraṁ vijayate śrī-kṛṣṇa-saṅkīrtanam.**

## How to run

1. Distribute the printable from the Saturday packet / Word builder `C3-W4.py`.
2. State the purpose in one sentence; name the care boundary: No ranking by volume; include full Śikṣāṣṭaka verse-1 source-language layer; invitation not contest.
