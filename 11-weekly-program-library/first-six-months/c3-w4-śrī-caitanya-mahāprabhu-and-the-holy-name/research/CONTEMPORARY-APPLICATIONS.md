# C3-W4 Contemporary Applications

| Case ID | Scenario | Principle applied | Facilitator note |
| --- | --- | --- | --- |
| CS-01 | Family schedule conflict over control | The congregational chanting of Kṛṣṇa's holy name cleanses th… | Anonymized; no forced disclosure |
