...
def main() -> None:
    print("INDEPENDENT MODULE SAMPLE")
    print("-" * 72)
    for prefix in SAMPLE_PREFIXES:
        ...
        print(f"{code:6} prem_words={prem_wc:4} newcomer_lines={newcom_lines:3} pack={pack} depth={depth} brief={brief} reg={reg}")
    ...
    for mod, needle, rel, bad in checks:
        ...
        print(f"  {mod}: {needle} -> {'PASS' if ok else 'FAIL'}")
